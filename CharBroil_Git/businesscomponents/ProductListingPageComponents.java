...
public class ProductListingPageComponents extends ReusableLibrary {
	...
	/************************************************************************************************************************
     * Function Name: selectRandomSimpleProductFromPLP_OLD Objective: To select Simple available product from PLP
	...
	public void selectRandomSimpleProductFromPLP_OLD()
	{
		try {
			...
			while(i<=15){  
				...
				if(!wdu.objectExists(ProductDetailsPage.lblOutofStock))	
				{
					...
					if(wdu.objectExists(ProductDetailsPage.selectColorPDP)==false)
					{
						...
						{
							report.updateTestLog("Product Details Page", "Product Details Page is Displayed after selecting product from PLP", Status.PASS);
							break;
						}
					}
					else
			...
			Thread.sleep(1000);
			//report.updateTestLog("Product Details Page", "Product Details Page is not Displayed after selecting product from PLP", Status.FAIL);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	/************************************************************************************************************************
     * Function Name: selectRandomConfigurableProductFromPLP_OLD Objective: To select Configurable available product from PLP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
		...
		try {
			...
			if (AppURL.contains("https://www.charbroil.com"))
			{
				...
				while(i<=15){  
					...
					{
						report.updateTestLog("Product Details Page", "Product " + i + " of the PLP is out of stock.", Status.PASS);
						driver.navigate().back();
					}
	...
	/************************************************************************************************************************
     * Function Name: validateRandomConfigurableProductFromPLP_OLD Objective: To select and validate available configurable product PDP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
...

				{
					if(wdu.objectExists(ProductDetailsPage.selectColorPDP)==true)
					{
						...
						if(wdu.objectExists(ProductDetailsPage.btnAddtoCartPDP)==true)
						{
							...
							{
								report.updateTestLog("Product Details Page", "Product Details Page validation is not successful", Status.FAIL);	
							}
	...
	/************************************************************************************************************************
     * Function Name: validateRandomSimpleProductPDP_OLD Objective: To select and validate available product PDP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
...
//							Thread.sleep(3000);
	...
	/************************************************************************************************************************
     * Function Name: selectRandomProduct Objective: To select a product from PLP after navigationm form the menu
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/	
	...
	/************************************************************************************************************************
     * Function Name: selecOutOfStockProductFromPLP Objective: To select Out of stock product from PLP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
		...
		try {
			...
			while(i<=10){  
				...
				try {
					...
					{
						report.updateTestLog("Product Details Page", "Product " + i + " of the PLP is not out of stock.", Status.PASS);
						driver.navigate().back();
					}
			...
			e.printStackTrace();
			report.updateTestLog("Exception in Selecting out of stock product from PLP", "Exception is " + e, Status.FAIL);
		}
	...
	/************************************************************************************************************************
     * Function Name: selectRandomConfigurableProductFromPLP Objective: To select Configurable available product from PLP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
				...
				while(i<=15){  
					...
					try {
						...
						try {
							...
							report.updateTestLog("Exception in Selecting product from PLP", "Exception is " + e2, Status.FAIL);
	...
	/************************************************************************************************************************
     * Function Name: selectRandomSimpleProductFromPLP Objective: To select Simple available product from PLP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
...
//				if(!wdu.objectExists(ProductDetailsPage.lblOutofStock))	
	...
	/************************************************************************************************************************
     * Function Name: validateRandomConfigurableProductFromPLP Objective: To select and validate available configurable product PDP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
	...
	/************************************************************************************************************************
     * Function Name: validateRandomSimpleProductPDP Objective: To select and validate available product PDP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
...
//							Thread.sleep(3000);
	...
	/************************************************************************************************************************
     * Function Name: selectProductFromPLPWithIndex Objective: To select a product from the PLP using index
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
	public void selectProductFromPLPWithIndex()
	{
		try {
				...
				{
					report.updateTestLog("Product Details Page", "Add to cart button is not Displayed after selecting product from PLP", Status.FAIL);
				}
	...
	/************************************************************************************************************************
     * Function Name: validateSimpleProductPDP_Direct Objective: To validate simple product directly in PDP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
	public void validateSimpleProductPDP_Direct()
	{
		...
		try {
								...
								if(
										driver.findElement(ProductDetailsPage.btnAddtoCartPDP).isDisplayed()&&
										driver.findElement(ProductDetailsPage.lblProductDescription).isDisplayed() && 
										driver.findElement(ProductDetailsPage.lblModelNumber).isDisplayed() &&
										driver.findElement(ProductDetailsPage.selectQuantity).isDisplayed() &&
										//driver.findElement(ProductDetailsPage.btnWhereToBuy).isDisplayed() &&
	...
	/************************************************************************************************************************
     * Function Name: validateConfigurableProductPDP_Direct Objective: To validate Configurable product directly in PDP
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
	public void validateConfigurableProductPDP_Direct()
	{
		...
		try {
			...
			e.printStackTrace();
			report.updateTestLog("Exception in Validating Configurable product in PDP", "Exception is " + e, Status.FAIL);
		}
	...
	/************************************************************************************************************************
     * Function Name: goToURL Objective: To get a URL
     * Created On: 07/01/2015 Created By: Arka Dasgupta
     * Automation Team Last Modified On: 02/13/2018 
     * Last Modified By: Arka Dasgupta
     ************************************************************************************************************************/
...
//			wdu.waitUntilPageReadyStateComplete(30);
//			
//			report.updateTestLog("Load URL", "Page Loading is successful..", Status.PASS);
//			
//			
	...
	public void validateOnSalePage() {
		...
		try {
			...
			{
				report.updateTestLog("Online Sale Page", "Online Sale page loading is successful",
						Status.PASS);

			} else {
				report.updateTestLog("Online Sale Page", "Online Sale page loading is not successful",
						Status.FAIL);
			}
			...
			e.printStackTrace();
			report.updateTestLog("Exception in while loading Online Sale page", "Exception is " + e,
					Status.FAIL);
		}
	...
	public void validateEllenShowPage() {
		...
		try {
			...
			{
				report.updateTestLog("Ellen Show Page", "Ellen Show page loading is successful",
						Status.PASS);

			} else {
				report.updateTestLog("Ellen Show Page", "Ellen Show page loading is not successful",
						Status.FAIL);
			}
			...
			e.printStackTrace();
			report.updateTestLog("Exception in while loading Ellen Show page", "Exception is " + e,
					Status.FAIL);
		}
	...
	public void validateHoliday2017Page() {
		...
		try {
			...
			{
				report.updateTestLog("Holiday 2017 Page", "Holiday 2018 page loading is successful",
						Status.PASS);

			} else {
				report.updateTestLog("Holiday 2017 Page", "Holiday 2018 page loading is not successful",
						Status.FAIL);
			}
			...
			e.printStackTrace();
			report.updateTestLog("Exception in while loading Holiday 2017 page", "Exception is " + e,
					Status.FAIL);
		}
	...
	/***************************************************************************************************************************************
	 * Function Name: validatePLPHeader Objective: To Validate PLP Header
	 * menu Crteated On: 08/03/2018 Created By: Arka Dasgupta Automation Team Last
	 * Modified By: Arka Dasgupta
	 ************************************************************************************************************************/
	...
	/***************************************************************************************************************************************
	 * Function Name: validatePLPHeader Objective: To Validate PLP BreadCrumb
	 * menu Crteated On: 08/03/2018 Created By: Arka Dasgupta Automation Team Last
	 * Modified By: Arka Dasgupta
	 ************************************************************************************************************************/
	public void validatePLPBreadCrumb() {
		...
		try {
			...
			wdu.waitUntilPageReadyStateComplete(40);
			Thread.sleep(3000);
			if (wdu.objectExists(ProductListingPage.lnkHomeBreadCrumb) && wdu.objectExists(ProductListingPage.lnlProductBreadCrumb)
					&& wdu.objectExists(ProductListingPage.lnkCategoryBreadCrumb)) {

				report.updateTestLog("PLP BreadCrumb Validation", "PLP BreadCrumb Validation is successful", Status.PASS);
			}

			else {
				report.updateTestLog("PLP BreadCrumb Validation", "PLP BreadCrumb Validation not successful", Status.FAIL);
			}
	...
	/***************************************************************************************************************************************
	 * Function Name: validatePLPProductCount Objective: To Validate PLP Product Count
	 * menu Crteated On: 08/03/2018 Created By: Arka Dasgupta Automation Team Last
	 * Modified By: Arka Dasgupta
	 ************************************************************************************************************************/
	public void validatePLPProductCount() {
		...
		try {
			...
			if (wdu.objectExists(ProductListingPage.lblPLPHeaderLeftPaneYellowBkgrnd)) {
				...
				if(productCount>0)
				{
					report.updateTestLog("PLP Product count Validation", "PLP Product count Validation is successful. Number of PLP Products is: "+productCount, Status.PASS);
				}
				
				else
				{
					report.updateTestLog("PLP Product count Validation", "PLP Product count Validation is not successful. Number of PLP Products is: "+productCount, Status.FAIL);
				}
	...
	/***************************************************************************************************************************************
	 * Function Name: validateShowMoreResults Objective: To Validate show more button functionality validation
	 * menu Crteated On: 08/03/2018 Created By: Arka Dasgupta Automation Team Last
	 * Modified By: Arka Dasgupta
	 ************************************************************************************************************************/
	public void validateShowMoreResults() {
		...
		try {
			...
			if (wdu.objectExists(ProductListingPage.lblKeywordSearchHeaderPLP)) {
				...
				{
					report.updateTestLog("PLP Show More Button Validation", "PLP Show More Button Validation is successful. Number of PLP Products is: "+productCount1, Status.PASS);
				}
				
				else
				{
					report.updateTestLog("PLP Show More Button Validation", "PLP Show More Button Validation is not successful. Number of PLP Products is: "+productCount1, Status.FAIL);
				}
	...
	public void validateSortBy() {
		...
		try {
			...
			if(productCount>0)
			{
				report.updateTestLog("PLP Sort by Validation", "PLP Sort by Validation is successful. Number of PLP Products is: "+productCount, Status.PASS);
			}
			
			else
			{
				report.updateTestLog("PLP Sort by Validation", "PLP Sort By Validation is not successful. Number of PLP Products is: "+productCount, Status.FAIL);
			}
