...
public class CheckOutComponents extends ReusableLibrary{
	...
	public void selectShippingMethod() 
	{
		...
		try {
			...
			if(wdu.objectExists(By.xpath(CheckOutPage.radioShippingMethod+"'"+shippingMethod+"')]/preceding-sibling::input")))
			{
				...
				driver.findElement(By.xpath(CheckOutPage.radioShippingMethod+"'"+shippingMethod+"')]/preceding-sibling::input")).click();
			}
	...
	public void placeOrder() 
	{
		...
		try {
			...
			if(driver.findElement(CheckOutPage.lblConfirmPurchase).isDisplayed())
			{
				...
				report.updateTestLog("Place Order", "Order has been placed Successfully with the order number: "+orderNumber, Status.PASS);
	...
	public void loginRegisteredUserCheckout() 
	{
		...
		try {
			...
			{
				report.updateTestLog("login Checkout", "Login while checkout with registered user is successful", Status.PASS);
			...
			{
				report.updateTestLog("login Checkout", "Login while checkout with registered user is not successful", Status.FAIL);
			}
	...
	public void billingInfoUsingPaypal() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Paypal Payment", "Payment using Paypal method navigated to paypal site successfully", Status.PASS);
			}


			else
			{
				report.updateTestLog("Paypal Payment", "Payment using Paypal method not navigated to paypal site successfully", Status.FAIL);
			}
	...
	public void validateCheckoutPageBreadCumb() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Checkout page Breadcumb Validation", "Validation of Checkout Page Breadcumb is Successful", Status.PASS);
			}


			else
			{
				report.updateTestLog("Checkout page Breadcumb Validation", "Validation of Checkout Page Breadcumb is not Successful", Status.FAIL);
			}
...
/**********************************************************************************************************************************************************************/	
	...
	public void validateBillingInfoAlignmentGuestUser() 
	{
		...
		try {
			...
			//gc.validateImage(System.getProperty("user.dir") + "\\images\\BillingInfoGuest.png", "Billing Info Page", "Billing Info Image Guest User");
			...
			e.printStackTrace();
			report.updateTestLog("Exception in validating billing info page alignment", "Exception is " + e, Status.FAIL);
		}
...
/**********************************************************************************************************************************************************************/	
	...
	public void validateBillingInfoAlignmentRegUser() 
	{
		...
		try {
			...
			//gc.validateImage(System.getProperty("user.dir") + "\\images\\BillingInfoRegisteered.png", "Billing Info Page", "Billing Info Image Registered User");
...
//			gc.validateImage(System.getProperty("user.dir") + "\\images\\ShoppingCart.png", "Shopping Cart Page", "Shopping Cart Page Validation");
			...
			e.printStackTrace();
			report.updateTestLog("Exception in validating Shopping cart page alignment", "Exception is " + e, Status.FAIL);
		}
...
/**********************************************************************************************************************************************************************/	
	...
	public void continueCheckout() 
	{
		...
		try {
			...
			if(driver.findElement(CheckOutPage.lblShippingMethod).isDisplayed())
			{
				report.updateTestLog("Navigation to Shipping Method", "Navigation to shipping method is successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Navigation to Shipping Method", "Navigation to shipping method is not successful", Status.FAIL);
			}
			...
			e.printStackTrace();
			report.updateTestLog("Exception while clicking on continue checkout button", "Exception is " + e, Status.FAIL);
		}
...
/**********************************************************************************************************************************************************************/	
	...
	public void loginInvalidUserCheckout() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Invalid user login Checkout", "Error message is displayed while trying to login with invalid user", Status.PASS);
...
System.out.println();
			...
			{
				report.updateTestLog("Invalid user login Checkout", "Error message is not diplayed while trying to login with invalid user", Status.FAIL);
			}
			...
			e.printStackTrace();
			report.updateTestLog("Exception in Invalid user login with registered user", "Exception is " + e, Status.FAIL);
		}
