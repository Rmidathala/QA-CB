...
public class ProductDetailsPageComponents extends ReusableLibrary{
	...
	public void proceedToCheckout() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Proceed to Check out", "Proceed to check out button is not displayed", Status.FAIL);
	...
	public void validateHomeBreadcumb() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate home Breadcumb", "Validating Home Breadcumb is not Successful", Status.FAIL);
			}
	...
	public void validateAddToCartButtonAlignment() 
	{
		...
		try {
			...
			gc.validateImage(System.getProperty("user.dir") + "\\images\\AddToCart.png", "Add to cart button", "Add to cart button in PDP Validation");
			...
			e.printStackTrace();
			report.updateTestLog("Exception in validating Add to cart button alignment", "Exception is " + e, Status.FAIL);
		}
	...
	public void validateConfigureProductAlignment() 
	{
		...
		try {
			...
			wdu.waitUntilElementEnabled(ProductDetailsPage.lblProductHeader, 15);
			gc.validateImage(System.getProperty("user.dir") + "\\images\\ConfigurePRD.png", "Add to cart button", "Add to cart button in PDP Validation");
	...
	public void validateWhereToBuyButtonAlignment() 
	{
		...
		try {
			...
			wdu.waitUntilElementEnabled(ProductDetailsPage.lblProductHeader, 15);
			gc.validateImage(System.getProperty("user.dir") + "\\images\\WhereToBuy.png", "Add to cart button", "Add to cart button in PDP Validation");
	...
	public void validateGuideManualSection() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate Guide and Manual Section", "Validating  Guide and Manual section is Successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Validate Guide and Manual Section", "Validating  Guide and Manual section is not Successful", Status.FAIL);
			}
	...
	public void validateSpecificationSection() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate Specification Section", "Validating  Specification section is Successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Validate Specification Section", "Validating  Specification section is not Successful", Status.FAIL);
			}
	...
	public void validatePartsSection() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate Parts Section", "Validating  Parts section is not Successful", Status.FAIL);
			}
	...
	public void validateSeeAllPartsSection() 
	{
		...
		try {
			...
			if(driver.findElement(ProductDetailsPage.btnSeeAllPartsofTheGrill).isDisplayed())
			{
				...
				{
					report.updateTestLog("Validate see all parts Section", "validation of See all parts button is successful", Status.PASS);
				}


				else
				{
					report.updateTestLog("Validate see all parts Section", "validation of See all parts button is not successful", Status.FAIL);
				}
			...
			{
				report.updateTestLog("Validate see all parts Section", "See all parts button is not present", Status.FAIL);
			}
	...
	public void validateThumbNailPDP() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate Youtube Thumbnail", "Validating  Youtube Thumbnail is Successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Validate Youtube Thumbnail", "Validating Youtube Thumbnail is not Successful", Status.FAIL);
			}
	...
	public void validateFrequentlyBoughtTogetherSection() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate Frequently Bought Together Section", "Validating  Frequently Bought Together Section is Successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Validate Frequently Bought Together Section", "Validating Frequently Bought Together Section is not Successful", Status.FAIL);
			}
			...
			e.printStackTrace();
			report.updateTestLog("Exception in validating Frequently Bought Together Section", "Exception is " + e, Status.FAIL);
		}
	...
	public void validateWhereToBuyButton() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate Where To buy Button", "Validating  Where To buy Button is Successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Validate Where To buy Button", "Validating Where To buy Button is not Successful", Status.FAIL);
			}
	...
	public void validatePriceSpider() 
	{
		...
		try {
			...
			gc.validateImage(System.getProperty("user.dir") + "\\images\\OnlineSellerHeader.png", "Price Spider Section", "Price Spider Section Validation");
			gc.validateImage(System.getProperty("user.dir") + "\\images\\PriceSpider.png", "Price Spider Section", "Price Spider Section Validation");
	...
	/************************************************************************************************************************
	 * Function Name: getInStockProductPDP Objective: To land into the PDP of a instock Product
	...
	/************************************************************************************************************************
	 * Function Name: validateAddAllToCart Objective: To validate add all to cart button in PDP
	 * Created On: 07/01/2015 Created By: Arka Dasgupta
	 * Automation Team Last Modified On: 02/13/2018 
	 * Last Modified By: Arka Dasgupta
	 ************************************************************************************************************************/
	...
	public void validateAddAllToCart() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Add All to cart Validation", "Add all to cart button validation is successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Add All to cart Validation", "Add all to cart button validation is not successful", Status.FAIL);
			}
	...
	/************************************************************************************************************************
	 * Function Name: validateFindPartPDP Objective: To validate Find Part in Product Details Page
	 * Created On: 07/01/2015 Created By: Arka Dasgupta
	 * Automation Team Last Modified On: 02/13/2018 
	 * Last Modified By: Arka Dasgupta
	 ************************************************************************************************************************/
	...
	public void validateFindPartPDP() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Find Part Validation", "Add all to cart button validation is successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Find Part Validation", "Add all to cart button validation is not successful", Status.FAIL);
			}
	...
	/************************************************************************************************************************
	 * Function Name: validateZoomFunctionality Objective: To validate Zoom Functionality in Product Details Page
	 * Created On: 07/01/2015 Created By: Arka Dasgupta
	 * Automation Team Last Modified On: 02/13/2018 
	 * Last Modified By: Arka Dasgupta
	 ************************************************************************************************************************/
	...
	public void validateZoomFunctionality() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Zoom Functionality Validation", "Zoom Functionality validation is successful", Status.PASS);
			}

			else
			{
				report.updateTestLog("Zoom Functionality Validation", "Zoom Functionality validation is not successful", Status.FAIL);
			}
		...
		try {
			...
			for (String handle : driver.getWindowHandles()) {
				if(!handle.equals(mainWindowHandle))	{
					...
					{
						report.updateTestLog("Validate Online Price Spider", "Model Number is not matched", Status.PASS);	
					}
	...
	public void validateAlsoInThisSeriesSection() 
	{
		...
		try {
			...
			if(driver.findElement(ProductDetailsPage.lblAlsoInThisSeries).isDisplayed())
			{
				...
				if(products.size()>0)
				{
					report.updateTestLog("Validate Also in This Series", "Validation of also in this series is successful", Status.PASS);
				}

				else
				{
					report.updateTestLog("Validate Also in This Series", "No products found in Also in this series section", Status.PASS);
				}
			}

			else
			{
				report.updateTestLog("Validate Also in This Series", "Also in this series header is not present", Status.FAIL);
	...
	public void validateWarrantyInGuideManual()	{
		try	{
			...
			for (int i=0 ; i<size ; i++) {
				...
				Thread.sleep(1000);
				report.updateTestLog("Validate warranty in PDP Guide Manual", "Clicked on the expansion link of Guide and Manual", Status.DONE);
			...
			e.printStackTrace();
			report.updateTestLog("Exception in warranty validation in Guide And Manual section", "Exception is " + e.getMessage(), Status.FAIL);
		}
	}
	...
	public void validateWarningInsideSpecification()	{
		try	{
			...
			report.updateTestLog("Warning inside specification validation", "Clicked on Specifications link", Status.DONE);
			Thread.sleep(1000);
			if(driver.findElement(ProductDetailsPage.lblWarning).isDisplayed())
			report.updateTestLog("Warning inside specification validation", "Warning label is displayed inside Specifications section", Status.PASS);
			else
				report.updateTestLog("Warning inside specification validation", "Warning label is not displayed inside Specifications section", Status.FAIL);
			
		} catch (Exception e) {
			e.printStackTrace();
			report.updateTestLog("Exception in warning message validation inside specifications", "Exception is " + e.getMessage(), Status.FAIL);
		}
	}
...
/*********************************************** Validate Description Section*******************************************************************************/	
	public void validatePDPDescription_EU() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Product Description Validation", "Product Description validation is successful", Status.PASS);
			}
			
			else
			{
				report.updateTestLog("Product Description Validation", "Product Description validation is not successful", Status.FAIL);
			}
...
/*************************************************************************************************************************************************************/	
	...
	public void validatePDPModelNumber_EU() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Product Model Number Validation", "Product Model Number validation is successful", Status.PASS);
			}
			
			else
			{
				report.updateTestLog("Product Model Number Validation", "Product Model Number validation is not successful", Status.FAIL);
			}
...
/*************************************************************************************************************************************************************/	
	...
	public void validateProductHeader_EU() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Product Header Validation", "Product Header validation is successful", Status.PASS);
			}
			
			else
			{
				report.updateTestLog("Product Header Validation", "Product Header validation is not successful", Status.FAIL);
			}
...
/*************************************************************************************************************************************************************/	
	...
	public void validateSupportPage_EU() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Support Page Validation", "Support Page validation is not successful", Status.FAIL);
			}
...
/****************************************************************** Validate Tips Section*******************************************************************************/	
		public void validateTipsSublinkSection() 
		{
			...
			try {
				...
				for(int i=1;i<sublinkNumber;i=i+2)
				{
					...
					wdu.mouseHoverJScript(driver.findElement(ProductDetailsPage.lnkHeaderMenuTips));
					Thread.sleep(2000);
					String linkText = driver.findElement(By.xpath("("+ProductDetailsPage.sublnksHeaderMenuTipsText+")["+i+"]")).getText();
					
					driver.findElement(By.xpath("("+ProductDetailsPage.sublnksHeaderMenuTipsText+")["+i+"]")).click();
					wdu.waitUntilPageReadyStateComplete(40);
					...
					{
						report.updateTestLog("Tips Sublink Validation", "Tips Sublink validation is successful. "
								+ "Total Sublinks available: "+actualSubLinkNumbers+". Sublink "+linkText+"has landed to next page with page header "+pageTitle, Status.PASS);
					}
					
					else
					{
						report.updateTestLog("Tips Sublink Validation", "Tips Sublink validation is not successful", Status.FAIL);
					}
		...
		public void validateTipsPageValidation() 
		{
			...
			try {
				...
				//wdu.waitUntilElementEnabled(ProductDetailsPage.lblTipsLinkPageHeader, 30);
					...
					{
						report.updateTestLog("Tips Validation", "Tips page validation is successful. Sublink numbers: "+actualSubLinkNumbers+". Sublink section numbers available is: "+sectionNumber, Status.PASS);
					}
	...
	public void validateWhyCharBroil() {
		...
		try {
			...
			if (wdu.objectExists(ProductDetailsPage.whyCharBroilBreadCrumb_1)
				...
				report.updateTestLog("Why CharBroil Validation", "Why CharBroil page validation is not successful", Status.FAIL);
			}
	...
	//		wdu.waitUntilElementEnabled(ProductDetailsPage.lblPromotionShippingHeader, 30);

			if (wdu.objectExists(ProductDetailsPage.lblPromotionPolicyDiscountDetails)) {
				
				
				if(wdu.objectExists(ProductDetailsPage.lblPromotionShippingHeader) || wdu.objectExists(ProductDetailsPage.lblPromotionShippingHeaderDK))
				{
					if(wdu.objectExists(ProductDetailsPage.lblPromotionGeneralPricingTermHeader) || wdu.objectExists(ProductDetailsPage.lblPromotionGeneralPricingTermHeaderDK))
					{
						report.updateTestLog("Promotion Policy Validation", "Promotion Policy page validation is successful",
								Status.PASS);
						
						if(wdu.objectExists(ProductDetailsPage.lblPromotionShippingDetails) || wdu.objectExists(ProductDetailsPage.lblPromotionShippingDetailsDK))
						{
						...
						{
							report.updateTestLog("Promotion Policy Validation", "Shipping Details Section is not displayed",
									Status.FAIL);
						}
					...
					{
						report.updateTestLog("Promotion Policy Validation", "General Pricing Term Header is not displayed",
								Status.FAIL);
					}
				}
				...
				report.updateTestLog("Promotion Policy Validation", "Promotion Policy page validation is not successful", Status.FAIL);
			}
	...
	public void validateBreadCrumbs_EU() {
		...
		try {
			...
			if (wdu.objectExists(ProductDetailsPage.brdcmbFirst) && 
					wdu.objectExists(ProductDetailsPage.brdcmbSecond) &&
					wdu.objectExists(ProductDetailsPage.brdcmbThird)) {
				
				report.updateTestLog("Bread Crumb Validation", "Bread Crumb validation is successful",
						Status.PASS);
			}
	...
	public void validateRatingSectionPDP_EU() {
		...
		try {
			...
			if (wdu.objectExists(ProductDetailsPage.lblSectionRatingAndReview)) {
				...
				report.updateTestLog("Rating Section Validation", "Rating Section validation is not successful", Status.FAIL);
			}
	...
	public void validateFrequentlyBoughtSection() 
	{
		...
		try {
			...
			{
				report.updateTestLog("Validate Frequently Bought Together Section", "Frequently Bought Together Section is displayed as expected", Status.PASS);
				...
				if(listOfElements.size()==3)
					report.updateTestLog("Validate Frequently Bought Together Section", "Number of products in frequently bought together section is : "+listOfElements.size(), Status.PASS);
				else
					report.updateTestLog("Validate Frequently Bought Together Section", "Product count mismatch in frequently bought together section ", Status.FAIL);
				
				if(driver.findElement(ProductDetailsPage.chkFrequentlyBoughtTogetherItem).isSelected())
					report.updateTestLog("Validate Frequently Bought Together Section", "Checkboxes in frequently bought section are all selected", Status.PASS);
				else
					report.updateTestLog("Validate Frequently Bought Together Section", "Checkboxes in frequently bought section are not selected", Status.FAIL);
				
			}
			else
			{
				report.updateTestLog("Validate Frequently Bought Together Section", "Issues in Frequently bought together section", Status.FAIL);	
			}
	...
	public void proceedToCheckoutWithPromoCodes() 
	{
		...
		try {
			...
			if(driver.findElement(CheckOutPage.btnProceedToCheckout).isDisplayed())
			{
				...
				{
					report.updateTestLog("Check Out Page", "Coupon code text field is displayed as expected", Status.PASS);	
					...
					if(driver.findElement(CheckOutPage.lblDiscountDetails).isDisplayed())
					{
						...
						report.updateTestLog("Check Out Page","Discount details displayed : "+discountdetails, Status.DONE);
					}
					else
					{
				...
				{
					report.updateTestLog("Check Out Page", "Coupon code text field is not displayed as expected", Status.FAIL);	
				}
